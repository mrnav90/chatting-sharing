 ...
 * the framework's lifecycle. The instance must be registered with the HYP 
 ...
 * @discussion This notification is issued upon a successful call to
 * -startWithOptions on the Hype singleton instance. When this notification
 * is triggered, Hype services are actively being advertised on the network
 ...
 * to stop, or otherwise forced to do so. If the services were forced to stop
 ...
 * event is only triggered once and Hype stops listening to adapter state events.
 * @param hype The HYP singleton instance.
 */
 ...
 * @discussion This notification is issued whenever the Hype instance
